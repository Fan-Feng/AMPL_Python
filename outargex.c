...
static real outargex(arglist *al)
{
    ...
    {
        if ((at[i] & (AMPLFUNC_INARG | AMPLFUNC_OUTARG | AMPLFUNC_STRING)) != (AMPLFUNC_INARG | AMPLFUNC_OUTARG))
        {
    ...
    if ((at[ms] & (AMPLFUNC_OUTARG | AMPLFUNC_STROUT)) != (AMPLFUNC_OUTARG | AMPLFUNC_STROUT))
    {
